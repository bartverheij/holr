...
It simply asserts that the suspect did not do it.
...
\begin{description}
	\item $S_1$: Suspect killed the victim when caught during a robbery.
	\item $S_3$: The victim's former partner murdered the victim after a violent fight between the two.
\end{description}
%
The two scenarios offer incompatible reconstructions of how the murder 
...
the victim's finger nails and his former partner. Scenario $S_3$ can explain the presences of the matching trace. The explanation is that the victim's former partner is the 
...
likely to be there. The scenario also shows the causal process that brought about the trace, namely the violent fight, altercation 
...
a quasi-inconsistency between scenarios and the evidence presented. The quasi-inconsistency occurs when the evidence, 
...
in which the victim's former partner is the murderer.  More carefully, insofar as the evidence 
