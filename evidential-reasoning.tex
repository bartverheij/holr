...
With this background in place, suppose now that a trace of blood---which allegedly came from the perpetrator---is found at the crime scene, and that the DNA profile created from the trace matches the DNA profile of a suspect. Using the match, 
...
Are DNA profiles unique? \citep{weir2007, KoehlerEtAl2010, kaye2013}  
...
$\Pr$(Guilt$|$Camera)$\approx \frac{0.07}{1+0.07}~\sim~6.5\%$.} This is a low probability, but still greater than 0.7\% or 0.01\%. 
This shows that the camera evidence by itself has incriminating evidential value, as it raises the guilt probability from 0.01\% to 6.5\%. However, when the partner's testimony is added as evidence, the support for the guilt hypothesis is weakened to 0.7\%. 
