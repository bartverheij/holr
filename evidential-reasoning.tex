...
conditioned on the evidence the \emph{posterior odds}.\footnote{The language of 'priors' and 'posteriors' is standard and suggests 
...
These numbers are purely illustrative, but are needed to perform the probabilistic calculations.\footnote{Of course, there remains the 
...
\paragraph{The probability of a composite hypothesis cannot in general be calculated from the probability of its components.} 
...
two items of evidence and two hypotheses?
