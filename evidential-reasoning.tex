...
%How can  $P(\textit{guilt}| \textit{DNA match}, \textit{testimony})$ be lower than  
%$P(\textit{guilt}| \textit{testimony})$ or $P(\textit{guilt}| \textit{DNA match})$? 
...
%So, putting everything together,
 %
 %\[\frac{P(\textit{guilt} | \textit{DNA match}, \textit{testimony})}{P(\neg \textit{guilt} | \textit{DNA match}, \textit{testimony})}=LR1\times LR2\times \frac{P(\textit{guilt})}{P(\neg \textit{guilt})}.\]
 %
%
