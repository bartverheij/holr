...
In many democratic countries, the trial system is engineered to favor the introduction of the evidence but it also contains rules 
that restrict the admissibility of the evidence. This section is devoted to an exploration of the legal rules for 
the introduction as well as the exclusion of the evidence. We shall confine ourselves to criminal trials in 
the United States at the federal level. This restriction is unfortunate but will allow us to keep the discussion focused. 

\paragraph{Introduction of the evidence: compulsory process and rules of discovery}

The 6th Amendment to the US Constitution establishes that a defendant in criminal trial has the right to force a witness to appear in court as part of its defense. In the words of the Constitution, ``in all criminal prosecutions, the accused shall enjoy the right ... to have compulsory process for obtaining witnesses in his favor.''  The compulsory process is considered a fundamental right, as fundamental as the right to a defense and the right to confront and cross-examine one's accusers in a court of law. The US Supreme Court, however, has held that this right is not limitless. In Taylor v.\ Illinois (1988), 484 U.S. 400, the Court held that a witness for the defense can be prevented from testifying if the witness testimony would conflict with other procedural rules. In the case at hand, the defense did not disclose to the prosecutor, prior to the trial, that a witness would be called to testify. Because of the failure to disclose, the trow, judge ruled that the defense had therefore no right to call the wiriness to the stand. The compulsory process was thus suspected because it conflicted with certain existing rules of discovery.  On defendant's appeal, both the Illinois Court of Appeals and the US Supreme Court sided with the trial judge.

Rules of discovery regulate how the prosecution and defense disclose to one another the items of evidence that they intend to present at trial. The rules of discovery vary from jurisdiction. At the federal level, for example, rule 16(a)(1)(E) mandates that upon defendant's request, the prosecute must disclose ``copy or photograph books, papers, documents, data, photographs, tangible objects, buildings or places'' which the prosecutor intend to use at trial. If the prosecutor complies with the defendant's request, however, Rule 16(b)(1)(A) mandates the defendant and should return the favor, as it were, if prosecutor so wishes. Criminal trials today tend to favor the transparent disclosure of the evidence prior to trial. This does not mean that the prosecution or the defense should disclose their strategies or all the details of the case, but at least, transparent disclosure avoids what we might call `surprise evidence' and allows both parties to prepare their case as diligently as possible. 

In broad terms, the compulsory process aims at ensuring that as much evidence as possible is introduced, at least on the part 
of the defendant. Interestingly enough, the prosecutor does not enjoy the constitutional right to compelling witness to testify.
This is a precise policy decision and makes legal proceedings---at least in principle---tilted in favor of defendants so that 
they can be better protected against wrongful convictions.  The rules of discovery, on the other, 
ensure that both party are as transparent as possible in terms of the evidence 
they intend to produce at trial.

\paragraph{Exclusionary rules}

Let us now turn to then rule for the exclusion of the evidence. In general, any relevant evidence is admissible 
unless it is deemed inadmissible on the basis of specific rules of exclusion of which we shall see some examples below.  
So, to determine admissibility, it is sufficient to determine that a piece of evidence is relevant, 
and that it is not deemed inadmissible by some exclusionary rules, 
