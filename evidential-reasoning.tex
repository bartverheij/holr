...
\paragraph{Cross examination} MAYBE A PARAGRAPH ABOUT CROSSO EXAMINATION HERE IS NEDDED?
...
Once all the evidence has been introduced at trial, examined and cross examined, it comes a time when the fact-finders, either a trained judge or a group of lay jurors, must make a decision. They must decide whether to convict or acquit the defendant in a criminal case, or whether to find against or in favor of the defendant in a civil case. There is no denying that the decision must be based on the evidence presented and the law governing the case, and not on human feelings. Still, this leaves an important question unanswered. 
What criterion should govern the decision? 

In continental Europe until the 18th century, strict rules of decision applied. For example, the testimony of one incriminating witness was deemed insufficient to prove that 
the defendant committed a crimea as serious as murder. Two witnesses were required, or alternatively, the confession of the suspect. This is often called the `two witness rule' inherited from Roman Law.  More generally, an elaborate system of legal arithmetic was in place. This system categorized proofs in full and half proofs, and described how one type of proof could be added to another. REFERENCES. With the Enlightenment, however, this system  disappeared and was replaced by the idea of free proof. The rationale for free proof is that since each juror is endowed with reason and common sense, she should be able to weigh the evidence and come to a reasoned conclusion without following strict, obscure and ultimately arbitrary rules for evidential reasoning. The history in England evolved differently because of the institution of the jury, but as it turns out, common law countries and countries in continental Europe both embraced the idea of free proof. Still, in light of the high number of documented wrongful convictions, some scholars have advocated the adoption rules of weight some of which are reminiscent of the two witness rule. One proposal, for example, is that no conviction can solely be based on one piece of incriminating evidence. REFERENCES

As things stand currently, however, the decision criterion consists of a \textit{standard of proof}, sometimes also called \textit{burden of persuasion} (not to be confused with the burden of proof, which includes both the burden of persuasion and the burden of production. REFERENCE.) The standard of proof determines how strongly the evidence should support the conclusion that the defendant is guilty or civilly liable. Failure to meet this standard must result in a finding in favor of the defendant. 
The decision criterion, at least for criminal trials in common law countries, is \textit{guilt beyond a reasonable doubt}, and a similar criterion exists 
in many other countries outside the common law. If the fact finders are persuaded of the defendant's guilt beyond a reasonable doubt, they should convict, or else they should acquit. In civil trials, instead, the standard is less demanding. A finding of civil liability against the defendant requires that the claim be established with \textit{preponderance of the evidence}, or else the fact finders must find for the defendant. 
