...
%Should the state bear this burden? 
%Should the cost be allocated to the parties according to the monetary resources available to each? 
%Should the party that initiates the litigation be responsible for most of the costs? Should the losing party bear the costs?
...
After all, the divergent interests of the parties---if left unchecked---%in presenting or withholding evidence 
...
to one another the evidence in their possession. %These rules vary significantly across criminal and civil cases. 
...
the introduction of the evidence at trial. %On this point, we shall say more later. 
