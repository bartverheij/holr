...
These are aspects of the scenarios considered \textit{per se}. In the previous section, however, 
we considered aspects of a scenario in relation to the evidence, such as plausibility and internal logical consistency (i.e.\ how well a scenario matches up with 
background information) and explanatory power and external consistency with the evidence (i.e.\ how well a scenario matches up with evidence specific to the case). 
...
is soemthign missing in the scenario if it does say why and how the victim's partner formed the intention to kill the victim. 
