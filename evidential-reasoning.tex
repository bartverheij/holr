...
conditional probability $\Pr(H|E)$ of hypothesis $H$ given evidence $E$ 
can be computed by the prior probability $\Pr(H)$ and the 
factor $\Pr(E|H)/\Pr(E)$.\endnote{The language of prior and posterior probability is standard 
...
or lower scores relative to the applicable evaluation criteria. Arguably, the scenario that gets the best score %, and that 
